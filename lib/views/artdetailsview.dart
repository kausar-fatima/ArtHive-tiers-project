...
import 'package:art_hive_app/views/components/whatsapp_button.dart';
                ...
                Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                  Padding(
                    ...
                    child: WhatsAppButton(
                      phoneNumber: widget.artData['phoneNo'],
                    ),
                  ),
                ]),
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          _buildDetailRow(
                              'Artist Style', widget.artData['artistStyle']!),
                          const SizedBox(height: 10),
                          _buildDetailRow(
                              'Price', "Rs ${widget.artData['price']}"),
                          const SizedBox(height: 10),
                          _buildDetailRow(
